...
"table_sub" =>"This is a list of the activities that you have stored on eigomonster. You can update these as you need to. Updating activities will automatically update them in the lesson plans that your teaching. If you want to create a variation, copy the activity and then edit that.",
...
"act_user_subject" => "Category",
"act_user_subject_help" => "Please select a category for this subject.",
"act_tags" =>"Tags",
...
"act_subject" =>"Category",
"act_subject_help" =>"The main category to which this activity belongs too.",
"act_user_subject" =>"Subject",
"act_user_subject_help" =>"The subject to which this activity belongs.",
...
"steps_adder_say" =>"What to say or do.",
...
"steps_adder_say_place" => "Let's stand up！",
"print_activity" => "Print"
