...
"students_head_sub" => "Students need to bring",//What students need to bring to class
"other" => "Other",
...
"sendtoemail_help" => "the email address for the person you would like to send this to.",//changed fo to for
"message_help" => "a message to help them understand why you are sending them this",//changed tehm to them
"sendbutton" => "send",
"your_name_help" => "the name from which this comment will come from.",//Changed from commen to comment
...
"act_search_h2_txt" => "you can search for activities that have been added to eigomonster by the teaching community. if youd find an activity you like remember to make a copy right away so that you save it as it is. users can modify their activities and you may not be able to find it again.",//Changed remeber to remember
